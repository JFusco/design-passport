...
/**
 * Returns the UTF-8 byte length without relying on TextEncoder. Figma's plugin
 * sandbox does not expose that browser global, so shared validation code must
 * remain portable across Node, browsers, and the plugin runtime.
 */
